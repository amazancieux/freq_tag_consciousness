...
def save_csv_file(subject_id): 
    ...
    output_file = f'./data/sub-{subject_id}/FreqTagStim_noreport_sub-{subject_id}.csv'     
...
for contrast in param.CONTRASTS:       
    for n_seq in range(0, param.NSEQ_NOREPORT):        
        seq = []
...
all_variable_names = trial_variable_names 
...
file = f'./data/sub-{subject}/fixCross_sub-{subject}_noreport.csv' 
